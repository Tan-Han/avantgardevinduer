...
<main>
    ...
    <article>
        <!-- farver -->
        <section class="ten-percent pb-5">
            <div class="flex">
                <div class="flex-col">
                    <hr class="hr-small">
                    <h3>
                            ...
                            <?php foreach ($farver as $post):
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <?php if (get_field("hex_color")): ?>
                                        <div style="background-color: <?php the_field("hex_color") ?>" class="farve-storrelse">
                                        </div>
        ...
        <section class="ten-percent pb-5">
            <div class="flex fordel gap-18 responsive-col">
                ...
                <div class="flex-col w-half">
                    <hr class="hr-small">
                    <h3 class="pb-2">
                        <?php the_field("fordel_1") ?>
                    </h3>
                    <div>
                        <h4 class="pb-1">
                            <?php the_field("fordel_subheadline_1") ?>
                        </h4>
                        <p class="pb-3">
                            <?php the_field("fordel_beskrivelse_1") ?>
                        </p>
                    </div>
                </div>
        ...
        <section class="ten-percent pb-5">
            <div class="flex fordel col-reverse gap-18">
                ...
                <div class="flex-col w-half">
                    <hr class="hr-small">
                    <h3 class="pb-2">
                        <?php the_field("fordel_2") ?>
                    </h3>
                    <div class="pb-3">
                        <h4 class="pb-1">
                            <?php the_field("fordel_2_subheadine_1") ?>
                        </h4>
                        <p class="pb-3">
                            <?php the_field("fordel_2_beskrivelse_1") ?>
                        </p>

                        <h4 class="pb-1">
                            <?php the_field("fordel_2_subheadine_2") ?>
                        </h4>
                        <p class="pb-3">
                            <?php the_field("fordel_2_beskrivelse_2") ?>
                        </p>

                        <h4 class="pb-1">
                            <?php the_field("fordel_2_subheadine_3") ?>
                        </h4>
                        <p>
                            <?php the_field("fordel_2_beskrivelse_3") ?>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="ten-percent pb-5">
            <div class="flex fordel">
                <div class="flex-col">
                    <hr class="hr-small">
                    <h3 class="pb-2">
                        <?php the_field("fordel_3") ?>
                    </h3>
                    <h4 class="pb-1">
                        <?php the_field("fordel_subheadline_3") ?>
                    </h4>
                    <p class="pb-3">
                        <?php the_field("fordel_beskrivelse_3") ?>
                    </p>
        ...
        <section class="ten-percent pb-5">
            <div class="flex fordel gap-18 responsive-col">
                <div class="flex-col w-half">
                    <hr class="hr-small">
                    <h3 class="pb-1">
                        <?php the_field("fordel_4") ?>
                    </h3>
                    <p class="pb-3">
                        <?php the_field("fordel_beskrivelse_4") ?>
                    </p>
                </div>
                <div class="flex-col w-half">
        ...
        <section class="ten-percent pb-5">
            <div class="flex fordel col-reverse gap-18">
                ...
                <div class="flex-col w-half">
                    <hr class="hr-small">
                    <h3 class="pb-1">
                        <?php the_field("fordel_5") ?>
                    </h3>
                    <p class="pb-3">
                        <?php the_field("fordel_beskrivelse_5") ?>
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="ten-percent pb-5">
            <div class="flex fordel">
                <div class="flex-col">
                    <hr class="hr-small">
                    <h3 class="pb-1">
                        <?php the_field("fordel_6") ?>
                    </h3>
                    <p class="pb-3">
                        <?php the_field("fordel_beskrivelse_6") ?>
                    </p>

                    <div class="w-3 img-size-adjust">
                        <?php $image6 = get_field("fordel_billede_6") ?>
                        <img src="<?php echo $image6["sizes"]["large"] ?>" alt="<?php echo $image6["alt"] ?>"
                            width="100%">
                    </div>
                </div>
            </div>
